...
main = tkinter.Tk()
main.title("EEVENT PROFILE BASED DEEP LEARNING FRAMEWORK FOR CYBER THREAT DETECTION") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='EVENT PROFILE BASED DEEP LEARNING FRAMEWORK FOR CYBER THREAT DETECTION"')
